...
set val(nn)     44                         ;# number of mobilenodes
set val(rp)     AODV                       ;# routing protocol
set val(x)      1879                      ;# X dimension of topography
set val(y)      964                      ;# Y dimension of topography
